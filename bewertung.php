...
<div class="container-fluid">
	...
	<h2><?php echo $chart->getSupplierName() ?></h2>
		...
		<a href="review_auswertung.php?lieferantid=<?=$lieferantid?>"><div class="btn btn-primary" style="margin-top:10px">Details</div></a>
    </div>
</div>
...
<script>
            ...
            data: {
                ...
                datasets: [
					<?php 
					$colors=["#e56bcd","#579dbc", "#e0a02e","#FF5430","#44EB1C","#1949B3", "#BFFF4A"];
					$ausgabe="";
