...
<div class="container-fluid">
    ...
    <div class="content">
        ...
        <a href="/uploads/anhang03_<?php echo $row["tender"] ?>.pdf" class="float-right" ><button type="button" class="btn btn-default"><i class="fas fa-file-download"></i>Anhang 3 herunterladen</button> </a>
        <a href="/uploads/anhang02_<?php echo $row["tender"] ?>.pdf" class="float-right" ><button type="button" class="btn btn-default"><i class="fas fa-file-download"></i>Anhang 2 herunterladen</button> </a>
        <a href="/uploads/anhang01_<?php echo $row["tender"] ?>.pdf" class="float-right" ><button type="button" class="btn btn-default"><i class="fas fa-file-download"></i>Anhang 1 herunterladen</button> </a>
        <br>
        <table class="table">
